...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_203181708";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "金金开发";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI4G8s48Fi1NxGtVZ3RGog"; //你的AccessKey ID
	private static final String SECRET_KEY="mQxDTeXSEmi7DWcGVm0IhbSDUdM8jx"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
//		测试短信发送
		SMSUtils.sendShortMessage(VALIDATE_CODE,"18576681082","aixuexia520");
	}
